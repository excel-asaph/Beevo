...
export const MODELS = {
    ...
    ARCHITECT_TEXT: 'gemini-2.5-flash',      // Fast, stable tool calling
...
export const SYSTEM_INSTRUCTIONS = {
  ...
  Return the result in JSON format matching the SWOT schema.`,
    ...
    2. When the user asks for a visual change OR a profile update (e.g. "Save this color"), YOU MUST NOT say "Done" immediately. You cannot see the future.
    3. PHASE 1 (Immediate): Say "I'm updating your profile..." or "Saving that choice...". STOP TALKING.
