        ...
        <div className="flex h-screen bg-slate-950 overflow-hidden text-slate-200">
                    ...
                    <div className="flex-1 overflow-y-auto space-y-3 pr-1 custom-scrollbar">
                        {thoughtStream.map(thought => (
                            <div key={thought.id} className="text-xs p-2 rounded bg-slate-800 border border-slate-700/50">
                                <span className={`inline-block px-1 rounded text-[10px] font-bold mb-1 ${
                                    thought.junction === Junction.STRATEGIST ? 'bg-blue-900 text-blue-300' :
            ...
            <main className="flex-1 overflow-hidden relative">
                ...
                <div className="h-full overflow-y-auto p-8 relative z-10">
                    ...
                    {currentJunction === Junction.ARCHITECT && <Architect />}
